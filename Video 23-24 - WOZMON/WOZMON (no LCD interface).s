...
RESET:
			...
			STA	ACIA_CTRL
			LDY	#$0B		; No parity, no echo, no interrupts
			STY	ACIA_CMD
...
NEXTCHAR:
			...
			LDA	ACIA_DATA	; Load Character. Bit 7 will be '0'
			STA	IN,Y		; Add to the text buffer
...
SETBLOCK:
			ASL				; Extra Shift left to set mode to BLOK
...
NEXTHEX:
			LDA	IN,Y		; Get character from hex test
